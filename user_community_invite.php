...
<div id="friends" style="display: inline-block;vertical-align: top; width: 200px;background-color: #eee;">
	<?php  #this part is for inviting user to a community

		$image = "images/user_male.jpg";
		if($FRIEND_ROW['gender'] == "Female")       #here first all users are given default profiel images according to their gender
		{
	...
	<a href="<?=ROOT?>profile/<?php echo $FRIEND_ROW['userid']; ?>">
 	...
 	<?php if(!is_invited($community_data['userid'],$FRIEND_ROW['userid'])):?>
 	<a href="<?=ROOT?>invite/<?=$community_data['userid']?>/<?=$FRIEND_ROW['userid']?>">
