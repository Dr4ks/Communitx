	...
	<div id="post" style="background-color: #eee;">    <!--this is comment section. Comments are displayed using this file-->
		<div>
		...
		<span style="color: #999;float:right">
			...
			<?php 
				...
				if($post->i_own_post($COMMENT['postid'],$_SESSION['communitx_userid'])){
			...
			<?php 
				...
				if(isset($_SESSION['communitx_userid'])){
					...
					if(is_array($result)){
						...
						if(in_array($_SESSION['communitx_userid'], $user_ids)){
							$i_liked = true;
						}
					}
