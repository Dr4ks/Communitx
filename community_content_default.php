		<div style="display: flex;">	  <!-- here it contains information about default case in communities -->
					...
					<div id="friends_bar">
						...
						Members<br>
							...
							<?php
								...
								$members = $community->get_members($community_data['userid'],10);
				...
				<!--posts area-->
 				<div style="min-height: 400px;flex:2.5;padding: 20px;padding-right: 0px;">
 					...
 					<?php if(!($community_data['community_type'] == 'public' && !community_access($_SESSION['communitx_userid'],$community_data,'member'))): ?>
