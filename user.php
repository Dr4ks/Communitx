...
<div id="friends" style="display: inline-block; width: 200px;background-color: #eee;">
	<?php     #this part shows all the necessary information and details aboot the user
	...
	<a href="<?=ROOT?><?php echo $FRIEND_ROW['type']; ?>/<?php echo $FRIEND_ROW['userid']; ?>">
		...
		<br>
		<?php echo $FRIEND_ROW['first_name'] . " " . $FRIEND_ROW['last_name'] ?>  <!-- user first name and last name are found and displayed on the screen -->
		<br>
		...
		<?php 
			...
			if($FRIEND_ROW['online'] > 0){
				...
				$current_time = time();
				$threshold = 60 * 2;//2 minutes             #here time is checked 
