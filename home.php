<?php 
	...
	include("classes/autoload.php");         #this is home page here all the posts which different users have created are displayed 
...
<!DOCTYPE html>
	<html>
	<head>
		<title>Timeline | Communitx</title>
	</head>
 				...
 				<div style="min-height: 400px;flex:2.5;padding: 20px;padding-right: 0px;">
	 				...
	 				<div id="post_bar">
 						...
 						<?php 
 							...
 							//$followers = $user_class->get_following($_SESSION['communitx_userid'],"user");
 							...
 							if($follower_ids){
 								$myuserid = $_SESSION['communitx_userid'];
