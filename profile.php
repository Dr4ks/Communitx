<?php
			#this part is for user profile when user is sucessfully logged in this part is displayed on the screen
	...
	$user_data = $login->check_login($_SESSION['communitx_userid'],false);
 	...
 	if(isset($URL[1]) && is_numeric($URL[1])){     #here is tis checked whether url has been set and it is numeric or not
	...
	if($_SERVER['REQUEST_METHOD'] == "POST")
	{
		...
		if(isset($_POST['first_name'])){
			...
			$settings_class->save_settings($_POST,$_SESSION['communitx_userid']);
			...
			<div style="background-color: white;text-align: center;color: #405d9b">
				...
				<span style="font-size: 12px;">
					...
					<?php if(i_own_content($user_data)):?>
						...
						<a onclick="show_change_profile_image(event)" style="text-decoration: none;color:#002DFE;" href="<?=ROOT?>change_profile_image/profile">Change Profile Image</a> | 
						<a onclick="show_change_cover_image(event)" style="text-decoration: none;color:#002DFE;" href="<?=ROOT?>change_profile_image/cover">Change Background</a>
				...
				<br>
					<div style="font-size: 20px;color: black;">
						...
						<?php  /*if($user_data['userid'] == $_SESSION['communitx_userid']): */ ?>
				...
				<?php 
					if($user_data['userid'] == $_SESSION['communitx_userid']){
						
						echo '<a href="'.ROOT. 'profile/'.$user_data['userid'].'/communities"><div id="menu_buttons">Communities</div></a>';
			...
			<!--below cover area-->
	 		...
	 		<?php 
	 			...
	 			if($section == "default"){
	 				...
	 				include("profile_content_communities.php");
	 			}
